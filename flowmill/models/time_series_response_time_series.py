...
class TimeSeriesResponseTimeSeries(object):
    ...
    def __init__(self, labels=None, source_labels=None, destination_labels=None, directionality=None, max_value=None, points=None, ok_points=None, bad_points=None):  # noqa: E501
        ...
        self._points = None
        self._ok_points = None
        self._bad_points = None
    ...
    @property
    def ok_points(self):
        """Gets the ok_points of this TimeSeriesResponseTimeSeries.  # noqa: E501
        ...
        :return: The ok_points of this TimeSeriesResponseTimeSeries.  # noqa: E501
        :rtype: GrpcPoint
        """
        return self._ok_points

    @ok_points.setter
    def ok_points(self, ok_points):
        """Sets the ok_points of this TimeSeriesResponseTimeSeries.

        When returning percent metrics, we also include the points used to compute the percent. These will be undefined for non-percent metrics.  Except for 'drops', all of the percent metrics have a suffix '_percent'.  Examples:  - for the metric 'drops' the ok_points will be 'tcp_packets' and    bad_points will be 'tcp_retrans'  - for the metric 'connection_errors_percent' the ok_points will be    'new_sockets' and the bad_points will be 'syn_timeouts'  # noqa: E501

        :param ok_points: The ok_points of this TimeSeriesResponseTimeSeries.  # noqa: E501
        :type: GrpcPoint
        """
    ...
    @property
    def bad_points(self):
        """Gets the bad_points of this TimeSeriesResponseTimeSeries.  # noqa: E501


        :return: The bad_points of this TimeSeriesResponseTimeSeries.  # noqa: E501
        :rtype: GrpcPoint
        """
        return self._bad_points

    @bad_points.setter
    def bad_points(self, bad_points):
        """Sets the bad_points of this TimeSeriesResponseTimeSeries.


        :param bad_points: The bad_points of this TimeSeriesResponseTimeSeries.  # noqa: E501
        :type: GrpcPoint
        """

        self._bad_points = bad_points
